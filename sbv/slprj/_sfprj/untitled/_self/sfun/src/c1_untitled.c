...
static real_T c1_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_Kthi, const char_T *c1_identifier);
  ...
  *chartInstance)
{
  ...
  c1_e_hoistedGlobal = chartInstance->c1_is_active_c1_untitled;
  ...
  const mxArray *c1_st)
{
  ...
  *c1_Kthi = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
  ...
  chartInstance->c1_is_active_c1_untitled = c1_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 4)), "is_active_c1_untitled");
  sf_mex_destroy(&c1_u);
...
static const mxArray *sf_get_sim_state_info_c1_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"C\",},{M[1],M[12],T\"Kd\",},{M[1],M[11],T\"Kp\",},{M[1],M[14],T\"Kthi\",},{M[8],M[0],T\"is_active_c1_untitled\",}}"
  };
