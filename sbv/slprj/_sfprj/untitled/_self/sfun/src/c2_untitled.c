...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(634313519U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2235435206U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1042551971U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(992534594U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("9dZzIq4sSY39GYRtxaq0jD");
...
static const mxArray *sf_get_sim_state_info_c2_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[10],T\"ddthi\",},{M[1],M[5],T\"ddx\",},{M[8],M[0],T\"is_active_c2_untitled\",}}"
  };
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2919760640U));
  ssSetChecksum1(S,(2395720360U));
  ssSetChecksum2(S,(2798513684U));
  ssSetChecksum3(S,(2096482361U));
